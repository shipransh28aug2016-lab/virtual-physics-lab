...
export const meta: ExperimentMeta = {
  id: 'emf-comparison', slug: 'emf-comparison',
  ...
  unit: 'practical-a', chapter: 'Unit II · Current Electricity', kind: 'theory', difficulty: 'moderate', tags: ['potentiometer', 'emf', 'cells', 'comparison', 'null deflection']
};
