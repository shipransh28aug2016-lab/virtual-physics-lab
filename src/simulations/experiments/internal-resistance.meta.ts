...
export const meta: ExperimentMeta = {
  id: 'internal-resistance', slug: 'internal-resistance',
  ...
  unit: 'practical-a', chapter: 'Unit II · Current Electricity', kind: 'theory', difficulty: 'moderate', tags: ['potentiometer', 'internal resistance', 'cell', 'null deflection']
};
