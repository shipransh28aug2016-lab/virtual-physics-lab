...
const config = { convex: true, id: meta.id, slug: meta.slug, title: meta.title, shortTitle: meta.shortTitle, aim: meta.aim, practicalNo: meta.practicalNo, unit: 'practical-b' as const, kind: 'practical' as const };
